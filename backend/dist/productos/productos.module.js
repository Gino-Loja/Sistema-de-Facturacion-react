...
const producto_schemas_1 = require("./schemas/producto.schemas");
let ProductosModule = class ProductosModule {
};
ProductosModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'productos', schema: producto_schemas_1.ProductoSchemas }])],
