...
const categoria_schemas_1 = require("./schemas/categoria.schemas");
const mongoose_1 = require("@nestjs/mongoose");
let CategoriasModule = class CategoriasModule {
};
CategoriasModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'categoria', schema: categoria_schemas_1.CategoriaSchemas }])],
