                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between pt-1">
                            ...
                            <strong> <span class="badge bg-secondary">New </span> Factura: # 1</strong>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-5">No se puede generar la factura</div>
