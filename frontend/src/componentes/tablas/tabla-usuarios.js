...
export function TablaUsuarios({ lista, editar, eliminar }) {
  const columns = useMemo(
    () => [
      ...
      {
        Header: 'Email',
        accessor: 'contacto.email',
      },
      {
        Header: 'Telefono',
        accessor: 'contacto.telefono',
      },
      {
        Header: 'Cargo',
        Cell: ({ row }) =>
          row.original.cargo.administrador ? 'Administrador' : 'Empleado',
      },
      {
        Header: 'Accion',
        Cell: ({ row }) => (
